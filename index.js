import require$$0, { useState, useRef, useLayoutEffect, Fragment, createContext, useContext, memo, useImperativeHandle, useEffect } from 'react';
...
function CacheComponent(_a) {
    ...
    return jsxRuntimeExports.jsx(Fragment, { children: activatedRef.current && createPortal(children, targetElement) });
}
...
function KeepAliveProvider(props) {
    ...
    return jsxRuntimeExports.jsx(KeepAliveContext.Provider, { value: { activeName: activeName, setActiveName: setActiveName }, children: children });
}
...
var KeepAlive = memo(function KeepAlive(props) {
    ...
    return (jsxRuntimeExports.jsxs(Fragment, { children: [jsxRuntimeExports.jsx("div", { ref: containerRef, className: "keep-alive" }), jsxRuntimeExports.jsx(KeepAliveProvider, { initialActiveName: activeName, children: cacheReactNodes === null || cacheReactNodes === void 0 ? void 0 : cacheReactNodes.map(function (_a) {
                    var name = _a.name, cache = _a.cache, ele = _a.ele;
                    return (jsxRuntimeExports.jsx(CacheComponent, { active: name === activeName, renderDiv: containerRef, cache: cache, name: name, children: ele }, name));
                }) })] }));
});
